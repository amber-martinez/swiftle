...
function Keyboard({ setCurrCol, setCurrRow, setCurrStr, currCol, currRow, currStr }) {
    ...
    alphabet1 = alphabet1.map(letter => (
        <Key letter={letter} setCurrCol={setCurrCol} setCurrRow={setCurrRow} currCol={currCol} currRow={currRow} currStr={currStr} setCurrStr={setCurrStr}/>
    ))
